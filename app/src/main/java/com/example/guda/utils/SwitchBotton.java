...
public class SwitchBotton extends View {    //滑动按钮
    //左圆半径
    private int center;
    //矩形x坐标
    private int rec_x;
    ...
    public SwitchBotton(Context context) {
        this(context, null);
    }

    public SwitchBotton(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwitchBotton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
